...
namespace MugShareApplication.Controllers
{
    public class BaseController : Controller
    {
        ...
        public void SetSessionObject(string key, object item)
        {
            Session[key] = item;
        }

        public void ClearSessionObject(string key)
        {
            Session[key] = null;
        }
    ...
    public static class StringCipher
    {
        ...
        {
            //passPhrase pulled from AppSettings key in Web.config file
            string passPhrase = System.Configuration.ConfigurationManager.AppSettings["CryptoPassPhrase"];
